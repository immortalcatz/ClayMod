...
public class EntityClayBallFX extends EntityFX
{
    public EntityClayBallFX(World par1World, double par2, double par4, double par6, Item par8Item)
    {
        this(par1World, par2, par4, par6, par8Item, 0);
    }

    public EntityClayBallFX(World par1World, double par2, double par4, double par6, Item par8Item, int par9)
    {
    ...
    public EntityClayBallFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, Item par14Item, int par15)
    {
        this(par1World, par2, par4, par6, par14Item, par15);
        this.motionX *= 1.00000000149011612D;
        this.motionY *= 1.00000000149011612D;
        this.motionZ *= 1.00000000149011612D;
        this.motionX += par8;
        this.motionY += par10;
        this.motionZ += par12;
    }
