...
public class EntityMudBallFX extends EntityFX
{
    public EntityMudBallFX(World par1World, double par2, double par4, double par6, Item par8Item)
    {
        this(par1World, par2, par4, par6, par8Item, 0);
    }

    public EntityMudBallFX(World par1World, double par2, double par4, double par6, Item par8Item, int par9)
    {
    ...
    public EntityMudBallFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, Item par14Item, int par15)
    {
