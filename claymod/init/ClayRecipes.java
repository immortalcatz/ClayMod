...
public class ClayRecipes {
	...
	private static void addColorRemoverRecipes(){
    	...
    	//Remove Colors & Repair
       	...
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[0], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[0], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[1], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[1], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[1], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[1], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[1], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[2], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[2], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[2], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[2], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[2], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[3], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[3], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[3], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[3], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[3], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[4], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[4], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[4], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[4], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[4], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[5], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[5], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[5], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[5], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[5], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[6], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[6], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[6], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[6], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[6], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[7], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[7], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[7], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[7], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[7], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[8], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[8], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[8], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[8], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[8], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[9], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[9], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[9], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[9], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[9], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[10], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[10], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[10], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[10], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[10], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[11], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[11], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[11], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[11], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[11], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[12], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[12], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[12], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[12], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[12], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[13], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[13], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[13], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[13], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[13], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[14], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[14], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[14], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[14], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[14], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[15], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[15], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[15], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[15], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[15], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayPickaxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayPickaxeArray[16], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayHoeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayHoeArray[16], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayAxeArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayAxeArray[16], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClayShovelArray[16], 1), new Object[] {CP.colorRemover, new ItemStack(CA.ClayShovelArray[16], 1, wild)});
       	GameRegistry.addShapelessRecipe(new ItemStack(CA.ClaySwordArray[16], 1), new Object[] {CP.colorRemover,new ItemStack( CA.ClaySwordArray[16], 1, wild)});
	}
}
