...
import claymod.effects.EntityClayBallFX;
import claymod.effects.EntityMudBallFX;
...
{
if (particleName.equals("mudballpoof"))
{
var21 = new EntityMudBallFX(theWorld, par2, par4, par6, (float)par8, (float)par10, (float)par12, ClayParts.mudBall, var14);
}
if (particleName.equals("clayballpoof"))
{
var21 = new EntityClayBallFX(theWorld, par2, par4, par6, (float)par8, (float)par10, (float)par12, ClayParts.homemadeClayBall, var14);
}
