...
public class CmMudThin extends Block
{
    ...
    public CmMudThin()
    {
        ...
        this.setBlockTextureName(ClayMod.modid + ":" + "mudBlock");
        this.setHarvestLevel("shovel", 0);
        this.setBlockName("mudThin");
    ...
    public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_, int p_149742_3_, int p_149742_4_)
    {
        ...
        return block != Blocks.ice && block != Blocks.packed_ice ? (block.isLeaves(p_149742_1_, p_149742_2_, p_149742_3_ - 1, p_149742_4_) ? true : (block == this && (p_149742_1_.getBlockMetadata(p_149742_2_, p_149742_3_ - 1, p_149742_4_) & 7) == 7 ? true : block.isOpaqueCube() && block.getMaterial().blocksMovement())) : true;
    }
